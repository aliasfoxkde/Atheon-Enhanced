...
## Implementation Plan
1. Add `shannonEntropy()` function in `core/entropy.go`
2. Add `MinEntropy` constant (3.0)
3. Integrate into `scanLines()` in `core/runner.go`
4. Add test coverage in `core/entropy_test.go`
